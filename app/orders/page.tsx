      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {loading ? (
          ...
          <div className="space-y-8">
            {/* Status Summary Tickers (Optional) */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
               {[
                 { label: 'Total Spent', value: `$${orders.reduce((acc, o) => acc + o.total_usd, 0).toLocaleString()}` },
                 { label: 'Active Orders', value: orders.filter(o => o.status !== 'cancelled' && o.status !== 'shipped').length },
