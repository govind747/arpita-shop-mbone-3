    ...
    return (
      <div className="min-h-[70vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-slate-500">Loading cart...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <aside className="lg:col-span-4 sticky top-24">
            ...
            <p className="mt-6 text-center text-xs font-medium text-slate-400 px-8">
              Need help with your order? <Link href="/support" className="text-brand-accent font-bold hover:underline">Contact ModernMart Support</Link>
            </p>
          </aside>
