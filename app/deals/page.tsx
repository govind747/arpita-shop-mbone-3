      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20 -mt-28 relative z-20">
          {[
            ...
            <div key={i} className={`bg-gradient-to-br ${cat.color} rounded-[2rem] p-8 text-white shadow-2xl ${cat.shadow} hover:-translate-y-2 transition-all duration-300 group cursor-pointer`}>
        ...
        <div className="relative mt-24 rounded-[3rem] bg-brand-accent p-12 md:p-20 overflow-hidden group">
          <div className="absolute top-0 right-0 -mt-20 -mr-20 h-80 w-80 bg-white/10 blur-[100px] rounded-full group-hover:bg-white/20 transition-all duration-700" />
