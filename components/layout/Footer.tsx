...
export function Footer() {
  ...
  return (
    <footer className="bg-slate-950 text-slate-300 pt-24 pb-12 border-t border-white/5 mt-20">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {['Privacy Policy', 'Terms of Service', 'Cookie Policy'].map((legal) => (
              <Link key={legal} href="#" className="text-slate-500 hover:text-white text-[10px] font-black uppercase tracking-widest transition-colors">
                {legal}
              </Link>
            ))}
          </div>
