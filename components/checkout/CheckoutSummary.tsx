...
export function CheckoutSummary() {
  ...
  useEffect(() => {
    fetchMbonePrice()
    // Refresh price every 30 seconds for that "Live" feel
  ...
  return (
    <div className="p-8 space-y-8">
      ...
      {/* Mini Product List - Scrollable if many items */}
      ...
      <div className="space-y-3 px-1">
        <div className="flex justify-between items-center text-sm">
          <span className="font-bold text-slate-400 uppercase tracking-tighter text-[11px]">Logistics</span>
        ...
        <div className="flex justify-between items-center text-sm">
          <span className="font-bold text-slate-400 uppercase tracking-tighter text-[11px]">Protocol Tax</span>
